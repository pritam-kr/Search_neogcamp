const database = {
  ...
  levelzero: [
    {
      ...
      link: "https://youtu.be/_L-UszPmy2A",
      img: "./yimg/1.png",
    ...
    },
    {
      ...
      link: "https://youtu.be/MMEIVh49pS8",
      img: "./yimg/2.png",
      des: "This session will set you up for the next class where we'll develop our very own portfolio website and blog. The blog part will be an assignment but I'll help you with that.",
    },
    {
    ...
    },
    {
      ...
      img: "./yimg/4.png",
      des: "In this course we will learn how to make your site pretty with CSS.",
    },
    {
  ...
  links: [
    {
      title: "Level zero all concept",
      link: "https://reminiscent-cold-fd5.notion.site/All-levelZero-Concepts-under-one-roof-8be7cf78c82c4489b061ff0b77e518cb",
    },
    {
      title: "Interview question",
      link: "https://github.com/neogcamp/build/blob/main/neog%20interview%20sample%20questions/interview-questions.md",
    },
    {
      title: "Interview question solutions",
      link: "https://interview-question.netlify.app/",
    },
    {
      title: "Logic build question",
      link: "https://github.com/neogcamp/build/tree/main/build-logic",
    },
    {
      title: "neogcamp addmission",
      link: "https://admissions.neog.camp/",
    },
    {
      title: "neogcamp discord server",
      link: "https://bit.ly/tanaydiscord",
    },
    {
      title: "neogcamp youtube channel",
      link: "https://www.youtube.com/channel/UCNFmBuclxQPe57orKiQbyfA",
    },
    {
      title: "levelZero playlist",
      link: "https://www.youtube.com/playlist?list=PLzvhQUIpvvuj5KPnyPyWsvgyzNkX_ACPA",
    },
    {
      title: "mark15",
    ...
    },
    {
      ...
      link: "https://neog.camp/guide/self-troubleshoot",
    },
    {
      title: "Interview tips",
      link: "https://neog.camp/qualifier/camp-interview-tips",
    },
    {
      title: "Practice question",
      link: "https://neog.camp/qualifier/camp-interview-practice",
    },
    {
      title: "Syllabus",
    ...
    database[inputValue].forEach((each) => {
      showTeams += `
            <div class="team_card">
                <img src="${each.img}" />
                <div class="bio">
                <h3>${each.title} <a href="${each.link}"><i class="fab fa-linkedin"></i></a> </h3>
                <h6>${each.job}</h6>
                <p>${each.des}</h6>
                </div>
            </div>`;
